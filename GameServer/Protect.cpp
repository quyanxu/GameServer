...
inline void CProtect::ErrorMessageBox() // OK
{
	...
	MessageBox(0,"Su licencia ha expirado.\n\nContacte a facebook.com/OficialMelo920","Error",MB_ICONERROR|MB_OK);
...
inline void CProtect::ErrorMessageBox2() // OK
{
	#if(PROTECT_STATE==1)
