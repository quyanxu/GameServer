...
enum eCommandNumber
{
	...
	COMMAND_MARRY_NEW		= 83,
	COMMAND_ACCEPT_MARRY	= 84,
	COMMAND_DIVORCE			= 85,
	COMMAND_FORCE_DIVORCE	= 86,
	COMMAND_TRACE_MARRY		= 87,
	COMMAND_MARRY_STATUS	= 88,
	COMMAND_SETLVL			= 109,
...
public:
	...
	bool SetMarry(LPOBJ lpObj,char* arg);
	...
	void ProposeMarry(LPOBJ lpObj,char * Wife);
	void AcceptMarry(LPOBJ lpObj);
	void DivorceMarry(LPOBJ lpObj);
	void ForceDivorceMarry(LPOBJ lpObj);
	void TraceMarry(LPOBJ lpObj);
	void StatusMarry(LPOBJ lpObj);
private:
